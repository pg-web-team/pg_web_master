...
import com.example.demo.service.IsaServiceRecordMonthlyReport;
...
public class IsaServiceRecordMonthlyReportApplication {


    private static final String CMD_LINE_SYNTAX = "java -jar IsaServiceRecordMonthlyReport.jar [args...]";
    private static final String CMD_LINE_EXAMPLE =
            "使用示例：\rjava -jar IsaServiceRecordMonthlyReport.jar -c 80012345 -s \"2019-09-19\" -e \"2019-09-29\" -n sso -env dev/qa/prod/config -pageSize 500";
    ...
    public static void main(String[] args) {
        ...
        if (params != null) {
            DbUtils.init(params);
            new IsaServiceRecordMonthlyReport().export(params);
    ...
    private static Map<String, String> parseCmdLine(String[] args) {
        ...
        Option opt6 = new Option("application", "application", true, "报表:  ");
        ...
        try {
            ...
            if (cli.hasOption("pageSize")) {
                paramMap.put("pageSize", cli.getOptionValue("pageSize"));
            }
