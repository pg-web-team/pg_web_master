...
import com.example.demo.service.CheckDetailMoreTenReport;
import com.example.demo.service.CheckDetailReport;
...
public class CheckDetailReportMoreTenApplication {

    private static final String CMD_LINE_SYNTAX = "java -jar CheckDetailReportMoreTen.jar [args...]";
    private static final String CMD_LINE_EXAMPLE =
        "使用示例：\rjava -jar CheckDetailReportMoreTen.jar -c 80012345 -s \"2019-09-19 22:22:22\" -e \"2019-09-29 22:22:22\" -n sso -env qa/prod";

    public static void main(String[] args) {
        Map<String, String> params = parseCmdLine(args);
        if (params != null) {
            DbUtils.init(params);
            new CheckDetailMoreTenReport().export(params);
        }
    }
